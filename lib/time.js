...
const { SEASONS } = require('../generic/enums')

/**
 * Months year is 245 days
 */
const months = [
    { name:'Ice', numberOfDays: 21, season: SEASONS.winter },
    { name:'Wind', numberOfDays: 20, season: SEASONS.winter },
    { name:'Sun', numberOfDays: 21, season: SEASONS.spring },
    { name:'Water', numberOfDays: 20, season: SEASONS.spring },
    { name:'Wood', numberOfDays: 19, season: SEASONS.spring },
    { name:'Light', numberOfDays: 21, season: SEASONS.summer },
    { name:'Dragon', numberOfDays: 20, season: SEASONS.summer },
    { name:'Fire', numberOfDays: 21, season: SEASONS.summer },
    { name:'Steel', numberOfDays: 20, season: SEASONS.fall },
    { name:'Stone', numberOfDays: 21, season: SEASONS.fall },
    { name:'Moon', numberOfDays: 20, season: SEASONS.fall },
    { name:'Darkness', numberOfDays: 21, season: SEASONS.winter }
]
...
const getBirthDate = (currentDate, age) => {
    ...
    let d = JSON.parse(JSON.stringify(date))
    d.year = bYear
    d.month = bMonth
    d.day = bDay
    return d
...
module.exports = {
    date, addDay, printDate, yearsPassed, getSeason, addMonth, getBirthDate,monthsPassed
}