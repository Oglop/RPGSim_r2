...
const { insertRoomBiomes } = require('./commands/insertRoomBiomes')
...
const { getRoomBiomeByRoomId } = require('./queries/getRoomBiomeByRoomId')
...
module.exports = {
    commands: {
        ...
        insertRoomBiomes: (roomBiomes) => insertRoomBiomes(roomBiomes), 
