...
describe('persistance tests', () => {
    test('character', async () => {
        ...
        expect(character.name).toBe(mock.name)
        expect(character.title).toBe(mock.title)
        expect(character.description).toBe(mock.description)
        expect(character.gender).toBe(mock.gender)
        expect(character.birthDate).toStrictEqual(mock.birthDate)
        expect(character.trait).toBe(mock.trait)
        expect(character.age).toBe(mock.age)
        expect(character.health).toBe(mock.health)
        expect(character.maxHealth).toBe(mock.maxHealth)
        expect(character.stamina).toBe(mock.stamina)
        expect(character.maxStamina).toBe(mock.maxStamina)
        expect(character.religion).toBe(mock.religion)
        expect(character.coatOfArms).toBe(mock.coatOfArms)
        expect(character.isAlive).toBe(mock.isAlive)
        expect(character.stats.str).toBe(mock.stats.str)
        expect(character.stats.vit).toBe(mock.stats.vit)
        expect(character.stats.agi).toBe(mock.stats.agi)
        expect(character.stats.wis).toBe(mock.stats.wis)
        expect(character.stats.int).toBe(mock.stats.int)
        expect(character.stats.cha).toBe(mock.stats.cha)
        expect(character.stats.luc).toBe(mock.stats.luc)
