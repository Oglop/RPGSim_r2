...
const equipFromSkills = character => {
    ...
    if (character.skills.includes(ENUM_SKILL_NAMES.heavyArmor)) {
        character.equipment.weaponHand = itemBuilder.build(ENUM_ITEM_TYPE.HEAVY_ARMOR, ENUM_ITEM_TIER.COMMON)
    } else if (character.skills.includes(ENUM_SKILL_NAMES.lightArmor)) {
        character.equipment.weaponHand = itemBuilder.build(ENUM_ITEM_TYPE.LIGHT_ARMOR, ENUM_ITEM_TIER.COMMON)
    } else if (character.skills.includes(ENUM_SKILL_NAMES.robes)) {
        character.equipment.weaponHand = itemBuilder.build(ENUM_ITEM_TYPE.ROBES, ENUM_ITEM_TIER.COMMON)
    }
